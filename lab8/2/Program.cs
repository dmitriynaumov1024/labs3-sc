...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        conveyor = new DataConveyor<Table<int>, object> {
            ...
            Handlers = new [] {
                DataHandlers.TableSizeCalculator.Cached(),
                DataHandlers.SumOfPositivesCalculator.Cached()
            },
        ...
        conveyor.Handlers[1] = DataHandlers.ProdOfNegativesCalculator.Cached();
        ...
        // Set up for N+1
        conveyor.Handlers[1] = DataHandlers.MeanOfNegativesCalculator.Cached();
